...
*/
$config['tables']['users']           = 'sgedb.users';
$config['tables']['groups']          = 'sgedb.groups';
$config['tables']['users_groups']    = 'sgedb.users_groups';
$config['tables']['login_attempts']  = 'sgedb.login_attempts';
