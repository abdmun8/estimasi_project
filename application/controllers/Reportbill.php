...
require_once(APPPATH . DIRECTORY_SEPARATOR . 'controllers' . DIRECTORY_SEPARATOR . 'BMaterial.php');

class Reportbill extends BMaterial
{
    ...
    public function billreport($id, $risk = 'FALSE')
    {
        /* Header */
        ...
        /* Grand Total */
        $alw = $this->db->get_where('v_wo_bom', ['id' =>  $id])->row()->allowance;
        ...
        FROM labour l
        JOIN bom_part_jasa j ON l.id_part_jasa = j.id
        WHERE l.id_header = $id AND l.tipe_name = 'ENGINEERING'
        ...
        /* Row 17 Right*/
        // $this->createRowIL($dataLbProd, 'Quality Control', 1);
        ...
        /* Row 18 Right*/
        // $this->createRowIL($dataLbProd, 'Safety Control', 1);
        ...
        /* Row 19 Right*/
        // $this->createRowIL($dataLbProd, 'After Sales', 1);
        ...
        $this->createLeftRow(21, $item);

        $this->pdf->Cell(5);
        $this->pdf->Cell(30, 4, 'OTHER COST', 0, 0);
        ...
        $this->createLeftRow(22, $item);

        /* Row 22 Right*/
        $this->createMaterialSummary([['key' => 'total_onsite', 'value' => 'ONSITE']], $dataSumMaterial, $alw);
        ...
        $this->pdf->Ln(4);
        $this->pdf->Cell(8, 4, 23, 1, 0, 'C');
        $this->pdf->Cell(42, 4, 'Overrage', 1, 0);
        $this->pdf->Cell(8, 4, number_format($alw) . "%", 1, 0, 'C');
