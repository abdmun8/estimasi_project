...
class Bmaterial_model extends Model {
    ...
    public function udpateDetailPart()
    {
        ...
        try {
            ...
            $this->db->update( 'bom_part_jasa', $data, ['id'=>$this->input->post('id-item')]);
            return TRUE;
        } catch (Exception $e) {
            return FALSE;
        }        
    ...
    public function insertMaterial()
    {
        ...
        $this->db->insert( 'bom_rawmaterial', $data );
    ...
    public function udpateMaterial()
    {
        ...
        $data = $this->getFieldMaterial();
        $this->db->update( 'bom_rawmaterial', $data, ['id'=>$this->input->post('id-material')]);
